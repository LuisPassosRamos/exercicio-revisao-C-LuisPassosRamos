...
// Fun��o para trocar elementos de posi��o
...
void imprimirListaAlunos(struct Aluno* lista) {
    ...
    while (lista != NULL) {
        printf("Matr�cula: %d, Nome: %s, M�dia: %.2f\n", lista->matricula, lista->nome, lista->media);
        lista = lista->proximo;
    }
}

// Fun��o para imprimir a lista de inteiros
...
int main() {
    ...
    inserirAluno(&listaAlunos, 12345, "Jo�o", 8.5);
